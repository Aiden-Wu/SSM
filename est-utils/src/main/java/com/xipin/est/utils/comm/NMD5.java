...
public class NMD5 {
	...
	public static String passwordEncode(String password,String salt){
		...
		NMD5 md5 = new NMD5();
		if(salt!=null){
			return md5.calcMD5(md5.calcMD5(password)+salt);
		}else{
			return md5.calcMD5(password);
		}
	}
	public static void main(String[] args) {
//		NMD5 md5 = new NMD5();
		//646db45d209009cd178d7b50e944e696
		//4f68a7024dd92aef39a7993204e2a35e
		//4f68a7024dd92aef39a7993204e2a35e
	    //System.out.println(md5.calcMD5(md5.calcMD5("111111")+"3744"));
		
		System.out.println(NMD5.passwordEncode("111111", "6947"));
